...
(5, '2024_03_29_141334_create_type_table', 1),
(6, '2024_03_29_141734_create_level_table', 1),
(7, '2024_03_29_141806_create_about_table', 1),
(8, '2024_03_29_142306_create_job_table', 1),
(9, '2024_03_29_143100_create_apply_to_table', 1);
...
--
-- Indexes for table `apply_to`
--
ALTER TABLE `apply_to`
  ADD PRIMARY KEY (`id`),
  ADD KEY `apply_to_jobid_foreign` (`jobId`);
...
ALTER TABLE `job`
  ADD PRIMARY KEY (`id`),
  ADD KEY `job_typeid_foreign` (`typeId`),
...
--
-- AUTO_INCREMENT for table `apply_to`
--
ALTER TABLE `apply_to`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `apply_to`
--
ALTER TABLE `apply_to`
  ADD CONSTRAINT `apply_to_jobid_foreign` FOREIGN KEY (`jobId`) REFERENCES `job` (`id`);
...
ALTER TABLE `job`
  ...
  ADD CONSTRAINT `job_typeid_foreign` FOREIGN KEY (`typeId`) REFERENCES `type` (`id`);
COMMIT;
